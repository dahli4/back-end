...
public class AuthController {
    ...
    public ResponseEntity<? super EmailCertificationResponseDto> emailCertification(
        ...
        ResponseEntity<? super EmailCertificationResponseDto> responseBody = authService
    ...
    public ResponseEntity<? super CheckCertificationResponseDto> checkCertification(
        ...
        ResponseEntity<? super CheckCertificationResponseDto> responseBody = authService
                .checkCertification(requestBody);
        return responseBody;
    }
